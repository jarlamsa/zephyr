...
#define MAX_COAP_MSG_LEN (CONFIG_COAP_ASYNC_CLIENT_MESSAGE_HEADER_SIZE + \
			  CONFIG_COAP_ASYNC_CLIENT_MESSAGE_SIZE)
...
struct coap_client {
	...
	K_THREAD_STACK_MEMBER(coap_thread_stack, CONFIG_COAP_ASYNC_CLIENT_STACK_SIZE);
};
/** @endcond */
